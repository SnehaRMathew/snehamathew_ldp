...
@Service
public class TokenEncodeService {
    private final JwtEncoder encoder;

    public TokenEncodeService(JwtEncoder encoder) {
    ...
    private static JwtEncoderParameters getJwtEncoderParameters(Authentication authentication) {
        ...
        JwtClaimsSet claims=JwtClaimsSet.builder()
                ...
                .claim("scope",scope)
                .build();
        var encodeParameters= JwtEncoderParameters.from(JwsHeader.with(MacAlgorithm.HS512).build(),claims);
